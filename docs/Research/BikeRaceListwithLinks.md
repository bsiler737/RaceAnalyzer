...
|---|---|---|---|---|---|---|---|
| Stage 1 — Mission Ridge Hill Climb (mass start) | `https://www.tourdebloom.com/stage-two` | Thu May 14, 2026 | Mission Ridge Ski and Board Resort, 7500 Mission Ridge Rd, Wenatchee, WA 98801 | Mileage 4.1; Elevation Gain 1,702; Gradient 12.8% | (No official RWGPS/Strava link exposed in page text)<br>**RWGPS (canonical 2026):** `https://ridewithgps.com/routes/49479652` (6.5km, 519m, MOUNTAINOUS)<br>RWGPS (older community): `https://ridewithgps.com/routes/2398131` | Official stage page includes numeric distance/elevation; RWGPS link is a “best available” climb route, not guaranteed to match race start exactly. citeturn52view1turn63search2 | id=603: `routes/46520450` (81km, HILLY) — likely wrong for HC |
